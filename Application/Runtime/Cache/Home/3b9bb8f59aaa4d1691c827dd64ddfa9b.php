    ...
    <div class="am-container">
        ...
        <div class="am-collapse am-topbar-collapse" id="collapse-head">
            <ul class="am-nav am-nav-pills am-topbar-nav">
                ...
                <div class="am-topbar-right">
                    <button class="am-btn am-btn-primary am-topbar-btn am-btn-sm" onclick="window.location.href='<?php echo U('About/index');?>'"><span class="am-icon-user"></span> 登录</button>
                </div>
  ...
  <div class="am-container">
    ...
    <div class="about-video-list">
      <div class="am-u-md-7 am-u-sm-12 about-video">
        <video src="/CloudDisk/Public/Home/video/video1.mp4" width="100%"  controls="controls" poster="/CloudDisk/Public/Home/images/about/video1.png" ></video>
      </div>
    ...
    <div class="about-video-list">
      <div class="am-u-md-7 am-u-sm-12 about-video">
        <video src="/CloudDisk/Public/Home/video/video2.mp4" width="100%"  controls="controls" poster="/CloudDisk/Public/Home/images/about/video2.png" ></video>
      </div>
      <div class="am-u-md-5 am-u-sm-12 about-video-word">
