...
<div class="banner">
  ...
  <div class="homepage-banner-img">
    <img src="/CloudDisk/Public/Home/images/banner_img.png" alt=""/>
  </div>
...
<div class="properties-mod module-wrap">
  <div class="am-container">
    <ul class="properties-list am-avg-sm-2 am-avg-md-4">
      <li >
        <img src="/CloudDisk/Public/Home/images/properties-img1.jpg" />
        <p>只需插入一行代码</p>
      </li>
      <li >
        <img src="/CloudDisk/Public/Home/images/properties-img2.jpg" />
        <p>网址不变</p>
      </li>
      <li>
        <img src="/CloudDisk/Public/Home/images/properties-img3.jpg" />
        <p>内容同步更新</p>
      </li>
      <li>
        <img src="/CloudDisk/Public/Home/images/properties-img4.jpg" />
        <p>云端加速</p>
      </li>
    </ul>
  </div>
  ...
  <div class="am-container">
    ...
    <div class="intro-list am-g">
      <div class="am-u-md-6 am-u-sm-12 intro-img">
        <img src="/CloudDisk/Public/Home/images/intro-img1.png" />
      </div>
    ...
    <div class="intro-list am-g">
      <div class="am-u-md-6 am-u-sm-12 intro-img">
        <img src="/CloudDisk/Public/Home/images/intro-img2.png" />
      </div>
    ...
    <div class="intro-list am-g">
      <div class="am-u-md-6 am-u-sm-12 intro-img">
        <img src="/CloudDisk/Public/Home/images/intro-img3.png" />
      </div>
