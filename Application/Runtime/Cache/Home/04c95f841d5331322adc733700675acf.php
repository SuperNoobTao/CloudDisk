    ...
    <div data-am-widget="slider" class="am-slider am-slider-default" data-am-slider='{&quot;controlNav&quot;:false}'>
      <ul class="am-slides">
        <li>
          <div class="case-item-mod">
              <div class="case-item-pic">
                  <img src="/CloudDisk/Public/Home/images/case/case-sample1.png" alt=""/>
              </div>
              <div class="case-item-text">
                <h5 class="company-logo"><img src="/CloudDisk/Public/Home/images/case/case-logo1.png" alt="Gov.cn" /></h5>
        ...
        <li>
          <div class="case-item-mod">
            <div class="case-item-pic">
              <img src="/CloudDisk/Public/Home/images/case/case-sample2.png" alt=""/>
            </div>
            <div class="case-item-text">
              <h5 class="company-logo"><img src="/CloudDisk/Public/Home/images/case/case-logo2.png" alt="微软亚太研发集团" /></h5>
        ...
        <li>
          <div class="case-item-mod">
            <div class="case-item-pic">
              <img src="/CloudDisk/Public/Home/images/case/case-sample3.png" alt=""/>
            </div>
            <div class="case-item-text">
              <h5 class="company-logo"><img src="/CloudDisk/Public/Home/images/case/case-logo3.png" alt="海信" /></h5>
        ...
        <li>
          <div class="case-item-mod">
            <div class="case-item-pic">
              <img src="/CloudDisk/Public/Home/images/case/case-sample4.png" alt=""/>
            </div>
            <div class="case-item-text">
              <h5 class="company-logo"><img src="/CloudDisk/Public/Home/images/case/case-logo4.png" alt="光明网" /></h5>
        ...
        <li>
          <div class="case-item-mod">
            <div class="case-item-pic">
              <img src="/CloudDisk/Public/Home/images/case/case-sample5.png" alt=""/>
            </div>
            <div class="case-item-text">
              <h5 class="company-logo"><img src="/CloudDisk/Public/Home/images/case/case-logo5.png" alt="罗莱家纺" /></h5>
        ...
        <li>
          <div class="case-item-mod">
            <div class="case-item-pic">
              <img src="/CloudDisk/Public/Home/images/case/case-sample6.png" alt=""/>
            </div>
            <div class="case-item-text">
              <h5 class="company-logo"><img src="/CloudDisk/Public/Home/images/case/case-logo6.png" alt="中国银泰" /></h5>
...
<?php if(is_array($castinfo)): $i = 0; $__LIST__ = $castinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><li>
        <div class="am-gallery-item">
          ...
          <img src="/CloudDisk/Public/Home/<?php echo ($c['siteimg']); ?>" alt="<?php echo ($c['sitename']); ?>"/>
        </div>
